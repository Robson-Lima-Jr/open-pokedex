...
type PalleteContextType = {
    pallete: "red" | "blue" | "yellow" | "green";
    changePallete: (value: "red" | "blue" | "yellow" | "green") => void;
};
...
export function PalleteProvider({children}: PalleteProviderProps) {
    const [pallete, setPallete] = useState<"red" | "blue" | "yellow" | "green">(() => {
        if(typeof window !== "undefined") {
            return(localStorage.getItem("pallete") as "red" | "blue" | "yellow" | "green") || "red";
        };

        return "red";
    });

    function changePallete(value: "red" | "blue" | "yellow" | "green") {
        setPallete(value);
    }

    // usar na classe body
    useEffect(() => {
        document.body.classList.remove("pallete_red", "pallete_blue", "pallete_yellow", "pallete_green");
